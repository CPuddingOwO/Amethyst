    ...
    public:
        ...
        bool Show() override {
            ...
            if (ImGui::BeginTable("AME#Bili-Main-Table", 3, ImGuiTableFlags_BordersOuter | ImGuiTableFlags_BordersInner | ImGuiTableFlags_SizingStretchProp))
            {
                ...
                float col0_width = ImGui::GetContentRegionAvail().x;
                float text_width = ImGui::CalcTextSize("User").x;
                ...
                float buttons_width = 2 * ImGui::CalcTextSize("Add").x + 2 * ImGui::GetStyle().FramePadding.x * 2 + ImGui::GetStyle().ItemSpacing.x;
                ...
                if (ImGui::BeginPopupModal("BiliHelper#UserAddingPopup", nullptr)) {
                    ...
                    if (ImGui::Button("Submit")) {
                        this->UM->AddUser({.cookie = SimpleCookie{.SESSDATA = cookie.SESSDATA, .bili_jct = cookie.bili_jct}});
                ...
                ImGui::TableSetColumnIndex(2);
                float button_width = ImGui::CalcTextSize("Refresh").x + ImGui::GetStyle().FramePadding.x * 2;
                ...
                TruncateText(IdentityCode, identity_value_width * 0.9, ImColorRed);
                ...
                ImGui::TableSetColumnIndex(2);
                // Column 2 can be left empty as requested
